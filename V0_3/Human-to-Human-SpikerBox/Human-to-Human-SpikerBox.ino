/*
  ...
  * Human to Human SpikerBox V0.3
  * Board V0.3 does not have potentiometers for pulse width and frequency 
  * so this code does not change frequency and pulse width. But whole code for ADC for potentiometers 
  * is implemented and it can be updated quickly to work with potentiometers.
  * 
  * TENS device code with Spike Recorder communication
  * 
  * Made for boards based on ATMEGA32U4 (Leonardo)
  * A0 - EMG input
  * A1 - ---
  * A2 - ---
  * A3 - Pulse width potentiometer (Not used on board V0.3)
  * A4 - Pulse frequency potentiometer  (Not used on board V0.3)
